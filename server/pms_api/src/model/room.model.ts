...
const roomSchema = new Schema<RoomType>({
  ...
  room_type: { type: String, required: true, ref: "RoomType" },
  room_type_code: { type: String, required: true, ref: "RoomType" },
  ...
  rate_plan_ids: [{ type: Schema.Types.ObjectId, ref: "RatePlan" }],
