...
exports.RatePlanRepository = void 0;
//         const update = {
//             $set: {
//                 // ratePlanCode: data.ratePlanCode,
...
//     }
// }
const ratePlanModel_1 = require("../model/ratePlanModel");
const ratePlanDateWise_model_1 = __importDefault(require("../model/ratePlanDateWise.model"));
class RatePlanRepository {
    upsertRateAmount(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield ratePlanModel_1.RateAmount.bulkWrite(operations);
            ...
            if (dateWiseRecords.length > 0) {
                yield ratePlanDateWise_model_1.default.insertMany(dateWiseRecords, { ordered: false });
...
exports.RatePlanRepository = RatePlanRepository;
//# sourceMappingURL=ratePlanRepository.js.map