...
class AnalyticsDAO {
    static buildMatchCondition(startDate, endDate, hotelCodes) {
    ...
    static getReservationStats(startDate, endDate, hotelCodes) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const matchCondition = this.buildMatchCondition(startDate, endDate, hotelCodes);
                const stats = yield reservationModel_1.ThirdPartyBooking.aggregate([
    ...
    static getReservationsByStatus(startDate, endDate, hotelCodes) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const matchCondition = this.buildMatchCondition(startDate, endDate, hotelCodes);
                const statusStats = yield reservationModel_1.ThirdPartyBooking.aggregate([
                    { $match: matchCondition },
                    {
                        $group: {
                            _id: "$status",
    ...
    static getMonthlyReservationTrends(startDate, endDate, hotelCodes, year) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let matchCondition = {};
                if (startDate || endDate) {
                ...
                const monthlyTrends = yield reservationModel_1.ThirdPartyBooking.aggregate([
                    {
                        $match: matchCondition,
                    },
                    {
    ...
    static getTopHotels(startDate_1, endDate_1, hotelCodes_1) {
        return __awaiter(this, arguments, void 0, function* (startDate, endDate, hotelCodes, limit = 5) {
            try {
                const matchCondition = this.buildMatchCondition(startDate, endDate, hotelCodes);
                const topHotels = yield reservationModel_1.ThirdPartyBooking.aggregate([
                    { $match: matchCondition },
                    {
                        $group: {
                            _id: "$hotelCode",
    ...
    static getCustomerAnalytics(startDate, endDate, hotelCodes) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const matchCondition = this.buildMatchCondition(startDate, endDate, hotelCodes);
                const customerStats = yield reservationModel_1.ThirdPartyBooking.aggregate([
                    { $match: matchCondition },
                    {
                        $group: {
                            _id: "$email",
    ...
    static getRevenueByPaymentMethod(startDate, endDate, hotelCodes) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const matchCondition = this.buildMatchCondition(startDate, endDate, hotelCodes);
                const paymentMethodStats = yield reservationModel_1.ThirdPartyBooking.aggregate([
                    { $match: matchCondition },
                    {
                        $group: {
                            _id: "$paymentMethod",
    ...
    static getReservationsByDateRange(startDate, endDate, hotelCodes, selectFields) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const matchCondition = this.buildMatchCondition(startDate, endDate, hotelCodes);
                let query = reservationModel_1.ThirdPartyBooking.find(matchCondition)
                    .sort({ createdAt: -1 });
                if (selectFields && selectFields.length > 0) {
                    query = query.select(selectFields.join(' '));
                }
                const reservations = yield query;
                return reservations;
            }
            catch (error) {
    ...
    static getCancellationAnalytics(startDate, endDate, hotelCodes) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const matchCondition = this.buildMatchCondition(startDate, endDate, hotelCodes);
                const results = yield reservationModel_1.ThirdPartyBooking.aggregate([
                    { $match: matchCondition },
                    {
                        $group: {
                            _id: null,
    ...
    static getOccupancyAnalytics(startDate, endDate, hotelCodes) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const matchCondition = this.buildMatchCondition(startDate, endDate, hotelCodes);
                const occupancyStats = yield reservationModel_1.ThirdPartyBooking.aggregate([
                    { $match: matchCondition },
                    {
                        $group: {
                            _id: "$hotelCode",
    ...
    static getDailyReservationTrends(startDate, endDate, hotelCodes) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const matchCondition = this.buildMatchCondition(startDate, endDate, hotelCodes);
                const dailyTrends = yield reservationModel_1.ThirdPartyBooking.aggregate([
                    {
                        $match: matchCondition,
                    },
                    {
    ...
    static getRoomTypeAnalytics(startDate, endDate, hotelCodes) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const matchCondition = this.buildMatchCondition(startDate, endDate, hotelCodes);
                const roomTypeStats = yield reservationModel_1.ThirdPartyBooking.aggregate([
                    { $match: matchCondition },
                    {
                        $group: {
                            _id: "$roomTypeCode",
    ...
    static getRatePlanAnalytics(startDate, endDate, hotelCodes) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const matchCondition = this.buildMatchCondition(startDate, endDate, hotelCodes);
                const ratePlanStats = yield reservationModel_1.ThirdPartyBooking.aggregate([
                    { $match: matchCondition },
                    {
                        $group: {
                            _id: "$ratePlanCode",
    ...
    static getCurrencyAnalytics(startDate, endDate, hotelCodes) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const matchCondition = this.buildMatchCondition(startDate, endDate, hotelCodes);
                const currencyStats = yield reservationModel_1.ThirdPartyBooking.aggregate([
                    { $match: matchCondition },
                    {
                        $group: {
                            _id: "$currencyCode",
