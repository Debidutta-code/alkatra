...
let PropertyInfo: Model<PropertyInfoType>;

try {
    // Try to get existing model
    PropertyInfo = mongoose.model<PropertyInfoType>('PropertyInfo');
} catch (error) {
    // If model doesn't exist, create it
    PropertyInfo = mongoose.model<PropertyInfoType>('PropertyInfo', propertyInfoSchema);
}
