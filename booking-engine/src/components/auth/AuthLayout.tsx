...
const AuthLayout: React.FC<AuthLayoutProps> = ({
  ...
  const responseGoogle = async(authResult: any) => {
    try{
      ...
      if (authResult?.code) {
        // Call your backend API to handle the Google login with the auth code
        ...
        <div className="w-full max-w-[410px] ">
          ...
          <div className="bg-tripswift-off-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] overflow-hidden transition-all duration-300 hover:shadow-[0_20px_80px_rgba(7,109,179,0.07)]">
            ...
            <div className="px-10 py-6 rounded-t-xl">
              ...
              <button
                onClick={ googleLogin }
                className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 rounded-lg py-3 mb-4 hover:bg-gray-50 transition-colors duration-200"
              >
                <svg className="w-5 h-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  />
                  <path
                    d="M46.98 24.55c0-1.7-.15-3.34-.43-4.91H24v9.28h12.88c-.56 2.97-2.25 5.49-4.78 7.17l7.98 6.19c4.64-4.29 7.34-10.62 7.34-17.73z"
                    fill="#4285F4"
                  />
                  <path
                    d="M10.54 28.28l-7.98-6.19C.95 25.35 0 29.06 0 33.5c0 4.44.95 8.15 2.56 11.41l7.98-6.19c-1.12-1.78-1.81-3.85-1.81-6.22 0-1.38.21-2.71.58-3.98z"
                    fill="#FBBC05"
                  />
                  <path
                    d="M24 48c6.48 0 11.93-2.15 15.89-5.85l-7.98-6.19c-2.22 1.49-5.03 2.38-7.91 2.38-6.26 0-11.57-4.22-13.47-9.91l-7.98 6.19C6.51 42.62 14.62 48 24 48z"
                    fill="#34A853"
                  />
                </svg>
                <span className="text-tripswift-black font-tripswift-medium">{}</span>
              </button>
