...
const HelpCenterTab: React.FC = () => {
  ...
  const handleFormSubmit = (data: { subject: string; message: string }) => {
    ...
    setTimeout(() => {
      ...
      // In real app: call your backend or EmailJS here
      setIsSending(false);
      setSendSuccess(true);
      ...
      setTimeout(() => {
        closeForm();
        setSendSuccess(false); // Reset for next open
      }, 1500);
    }, 1000);
  };
    ...
    <>
      ...
      <div className="space-y-8 px-4 sm:px-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4 sm:p-6">
          ...
          {/* Email Support Card - Opens Modal */}
          <div className="flex justify-center mb-6">
            <button
              onClick={openForm}
              className="bg-green-50 border border-green-200 rounded-xl p-4 w-full max-w-md text-left hover:shadow-md focus:outline-none focus:ring-2 focus:ring-green-300 transition-all"
            >
