          ...
          <div className="p-5 sm:p-6">
            ...
            <div className="flex justify-end">
              <Link href={`/app/property/propertyDetails?propertyId=${hotel._id}`}>
                <Button
                  size="sm"
                  className="bg-tripswift-blue hover:bg-tripswift-blue-600 text-white shadow-sm transition-all duration-200 hover:shadow-md flex items-center gap-2 px-4 py-2 rounded-lg"
                >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <div className="sm:ml-4 flex-shrink-0 flex justify-end">
                  <Link href={`/app/property/propertyDetails?propertyId=${hotel._id}`}>
                    <Button
                      size="sm"
                      className="bg-tripswift-blue hover:bg-tripswift-blue-600 text-white shadow-sm transition-all duration-200 hover:shadow flex items-center gap-2 px-4 py-2.5 rounded-lg min-w-28"
                    >
                      <Eye className="w-4 h-4" />
