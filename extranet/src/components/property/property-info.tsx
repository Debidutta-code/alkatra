...
const createPropertySchema = z.object({
  ...
  property_email: z
    ...
    .email("Please provide a valid email address").regex(gmailRegex, "Please provide a valid email address"),
...
export default function PropertyInfo({ onNext }: Props) {
  ...
  if (propertyId && !editMode) {
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
          ...
          <div className="items-center justify-center gap-4">
            <div className="w-full">
              <Label htmlFor="property_name">Property Name <span className="text-destructive">*</span></Label>
              <Input
                id="property_name"
              ...
              />
              {propertyNameError && (
                <p className="text-red-500 text-sm mt-1">{propertyNameError.message}</p>
              )}
            </div>
            <div className="w-full">
              <Label htmlFor="property_email">Property Email <span className="text-destructive">*</span></Label>
              <Input
                id="property_email"
                size={"md"}
                ...
                type="email"
                value={propertyData?.property_email}
              />
              {propertyEmailError && (
                <p className="text-red-500 text-sm mt-1">{propertyEmailError.message}</p>
              )}
            </div>
          </div>
          <div className="items-center justify-center gap-4">
            <div className="w-full">
              <Label htmlFor="property_contact">Property Contact <span className="text-destructive">*</span></Label>
              <Input
                id="property_contact"
                size={"md"}
          ...
          <div className="items-center gap-4">
            <div className="w-40 sm:mb-0 mb-4">
              ...
              <Input
                ...
                value={propertyData?.star_rating}
              />
              {starRatingError && (
                <p className="text-red-500 text-sm mt-1">{starRatingError.message}</p>
              )}
            </div>
            <div className="self-end h-15 relative mt-2">
            ...
            <div className="self-end w-full relative mt-4">
              <Label htmlFor="property_category">Property Category <span className="text-destructive">*</span></Label>
              <div className="inline-block relative w-full">
                <select
                  {...register("property_category")}
                  value={propertyDetails?.property_category}
                  onChange={(e) => setPropertyDetails({ ...propertyDetails, property_category: e.target.value })}
                  className={`block appearance-none w-full border ${propertyCategoryError ? "border-red-500" : "border-input"
                    } bg-background text-foreground py-2 px-3 rounded-md leading-tight focus:outline-none focus:ring-2 focus:ring-ring focus:border-input`}
                >
                ...
                {propertyCategoryError && (
                  <p className="text-red-500 text-sm mt-1">{propertyCategoryError.message}</p>
                )}
            ...
            <div className="self-end w-full relative mt-4">
              ...
              <div className="inline-block relative w-full">
                <select
                  ...
                  onChange={(e) => setPropertyDetails({ ...propertyDetails, property_type: e.target.value })}
                  className={`block appearance-none w-full border ${propertyTypeError ? "border-red-500" : "border-input"
                    } bg-background text-foreground py-2 px-3 rounded-md leading-tight focus:outline-none focus:ring-2 focus:ring-ring focus:border-input`}
                >
                  {loading ? (
                    <option value="">Loading...</option>
            ...
            <div className="self-end w-mid relative">
              <div className="inline-block relative w-full mb-4 mt-2">
    ...
    return (
      <>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 pt-0 p-6 min-h-screen">
          <CardTitle>Property Details</CardTitle>
          <div className="items-center justify-center gap-4">
          ...
          <div className="items-center gap-4 mb-5">
            ...
            <div className="self-end h-15 relative my-3">
              {propertyImageUrls?.length ? (
                <PreviewPropertyImages
                  open={propertyImagePreviewDialog}
                  setOpen={setPropertyImagePreviewDialog}
            ...
            <div className="self-end w-full relative">
              ...
              <div className="inline-block relative w-full">
                <select
                  {...register("property_category")}
                  className={`block appearance-none w-full border ${propertyCategoryError ? "border-red-500" : "border-gray-300 dark:border-gray-600"
                    } bg-white dark:bg-gray-900 text-gray-900 dark:text-white py-2 px-3 rounded-md leading-tight focus:outline-none focus:border-primary-500`}
                >
                  <option value="" disabled>Select Property Category</option>
            ...
            <div className="self-end w-full relative mt-4">
              <Label htmlFor="property_type">Property Type <span className="text-destructive"><span className="text-destructive">*</span></span></Label>
              <div className="inline-block relative w-full">
                <select
                  {...register("property_type")}
                  className={`block appearance-none w-full border ${propertyTypeError ? "border-red-500" : "border-gray-300 dark:border-gray-600"
                    } bg-white dark:bg-gray-900 text-gray-900 dark:text-white py-2 px-3 rounded-md leading-tight focus:outline-none focus:border-blue-500`}
                >
